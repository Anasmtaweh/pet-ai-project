          ...
          <ListGroup.Item key={pet._id} className={styles.petItem}>
            <Row className="align-items-center">
              ...
              <Col xs={12} md={5}>
                <div className={styles.petInfoContainer}>
                  ...
                  <div className={styles.speciesInfo}>
                    {pet.species === 'Cat' ? (
                      <FaCat className={styles.speciesIcon} aria-hidden="true" />
                    ) : (
                      <FaDog className={styles.speciesIcon} aria-hidden="true" />
                    )}
                  ...
                  <div className={styles.petInfo}>
                    {pet.gender === 'Male' ? (
                      <FaMars className={styles.infoIcon} aria-hidden="true" />
                    ) : (
                      <FaVenus className={styles.infoIcon} aria-hidden="true" />
                    )}
              ...
              >
                ...
                <Button
                  variant="danger"
                  className={`${styles.deleteButton} w-100`}
