...
function AdminPetManagement() {
  ...
  return (
    <Container className={styles.petManagementContainer}>
      ...
      <Table striped bordered hover responsive className={styles.petManagementTable}>
        {' '}
        {/* Added responsive for better table display on small screens */}
        <thead>
          <tr>
            <th>Pet Name</th>
          ...
          {pets.map((pet) => (
            <tr key={pet._id}>
              ...
              <td>
                ...
                {pet.species === 'Dog' ? <FaDog /> : pet.species === 'Cat' ? <FaCat /> : ''}{' '}
                {pet.species}
              </td>
              <td>{pet.breed}</td>
              <td>
              ...
              <td>
                <Button
                  ...
                  onClick={() => handleShowModal(pet._id)}
                >
                  Delete
                </Button>
              </td>
