      ...
      <Container>
        <Row className="align-items-center">
          ...
          <Col md={4} className="mb-3 mb-md-0">
            ...
            <div className="d-flex">
              <a
                ...
                className={`text-light me-3 ${styles.footerA}`}
              >
                <FaInstagram size={24} />
              </a>
              <a
                href="https://www.reddit.com/r/cats/s/avvgLwnNSy"
                target="_blank"
                rel="noopener noreferrer"
                className={`text-light ${styles.footerA}`}
              >
                <FaReddit size={24} />
              </a>
            </div>
          ...
          <Col md={4} className="text-md-end">
            <p className="mb-1">&copy; {new Date().getFullYear()} MISHTIKA</p>
            <p className="mb-0">
              Developed by{' '}
              <a
                href="https://github.com/Anasmtaweh"
                target="_blank"
                rel="noopener noreferrer"
                className={`text-light ${styles.footerA}`}
              >
