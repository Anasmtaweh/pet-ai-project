// Test suite for schedule utility functions, specifically for generating occurrences.
...
describe('Schedule Utils', () => {
  // Define a mock schedule rule to be used across multiple tests.
  const mockRule = {
    _id: 'schedule-123',
  ...
  it('should generate daily occurrences', () => {
    ...
    // Expect occurrences for Jan 1st and Jan 2nd.
  ...
  // Test case: Verifies that occurrences falling on an exception date are correctly excluded.
  ...
  // Test case: Verifies that occurrences are generated correctly when the rule's start date is before the window,
